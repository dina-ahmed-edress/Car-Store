...
if($_SERVER["REQUEST_METHOD"] === "POST")
{
           ...
           try{
            $sql="UPDATE `categores` SET `category`=? WHERE `id`=?";
 ...
 try{
            $sql = "SELECT * FROM `categores` WHERE id =?";
            $stmt = $conn->prepare($sql);
            $stmt->execute([$id]);
            $result=$stmt->fetch();
									...
									<form action="" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text"  name="category" id="add-category"  required="required" class="form-control " value="<?php echo $category ?>">
											</div>
										</div>
