  ...
  if(isset($_POST["active"]))
 	...
 	$active=0;
           ...
           try{
            ...
            $stmt->execute([$fullname, $username, $email,$pass,$active,$id]);
             echo "update succiss";
									...
									<form action="" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="fullname"  required="required" class="form-control " value="<?php echo $fullname ?>">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													...
													<input type="checkbox" id="flat" name="active" <?php echo $activestr?> >
												</label>
											</div>
										</div>
										<div class="item form-group">
